  ...
  <div class="card shadow mb-4" style="z-index: 1;">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Daftar Barang
        ...
        foreach ($barang as $brg) : ?>
            <tr style="text-align: center">
                ...
                <td>
                    ...
                    <b title="Edit"> <?php echo anchor('brg/ubahData/'. $brg['id_brg'],'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div></td>');?>
                    </b>
                </td>
            </tr>
        <?php $i++;
